...
```{r load_libs_supp06,message=FALSE}
# load libs
library(raster)
library(gstat)
library(stars)
...
```{r load_data_supp06,message=FALSE}
...
```{r make_variograms,message=FALSE}
# prep variograms
...
```{r plot_variograms_maps,message=FALSE}
...
```{r resample_landcover_mult,warning=FALSE, message=FALSE}
...
```{r read_resampled_lc,message=FALSE, warning=FALSE}
...
```{r load_hills_s06,message=FALSE, warning=FALSE}
# load hills
library(sf)
...
```{r chelsa_rasters_s06,message=FALSE, warning=FALSE}
# list chelsa files
...
```{r resample_clim_rasters,message=FALSE}
# make resampled data
