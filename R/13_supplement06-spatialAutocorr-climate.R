## ----load_libs_supp06, eval=FALSE, message=FALSE------------------------------
## # load libs
## library(raster)
## library(gstat)
## library(stars)
...
## ----make_variograms, eval=FALSE, message=FALSE-------------------------------
## # prep variograms
...
## ----load_map_data, eval=FALSE, message = FALSE-------------------------------
...
## ----plot_variograms_maps, eval=FALSE, message=FALSE--------------------------
...
## ----read_resampled_lc, eval=FALSE, message=FALSE, warning=FALSE--------------
...
## ----load_hills_s06, eval=FALSE, message=FALSE, warning=FALSE-----------------
## # load hills
## library(sf)
...
## -----------------------------------------------------------------------------
# ![CHELSA rasters with study area outline, at different scales. 
# Semivariograms are on a log-transformed y-axis.](figs/fig_chelsa_resamp.png)
