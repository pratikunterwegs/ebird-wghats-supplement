...
## ----strict_filter_supp02, eval=FALSE-----------------------------------------
...
## ----plot_obs_distributions, eval=FALSE, echo=FALSE---------------------------
## # make plot
## wg <- st_transform(wg, 32643)
## bbox <- st_bbox(wg)
##
...
## # export data
## ggsave(plotNchk,
##   filename = "figs/fig_number_checklists_10km.png", height = 12,
