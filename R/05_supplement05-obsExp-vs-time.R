...
#' 
## ----load_data_supp05,message=FALSE-------------------------------------------
...
#' 
## ----exp_landcover,message=FALSE, echo=FALSE----------------------------------
...
#' 
#' ![Distribution of expertise scores across the seven landcover classes present in the study site.](figs/fig_exp_lc.png)
