...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\CommentTok{# ![CHELSA rasters with study area outline, at different scales. }
\CommentTok{# Semivariograms are on a log-transformed y-axis.](figs/fig_chelsa_resamp.png)}
\end{Highlighting}
\end{Shaded}
